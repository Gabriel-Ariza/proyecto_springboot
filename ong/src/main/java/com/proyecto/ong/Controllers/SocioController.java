...
public class SocioController {
    ...
    @GetMapping("/socioTipoCuota/{tipoCuota}")
    List<SocioDTO> findAllSocioByTipoCuota(@PathVariable("tipoCuota") Cuota.tipoCuota tipoCuota){
        return socioService.findAllSocioByTipoCuota(tipoCuota);
    }
